...
- 'run_timing' reproduces Figure 3 (for no-noise simulations comment line ??? instead of ??? in 'ode.py'). To consider paired-pulses instead of single pulses of the neurotransmitter, see 'ACh_pulses.py'
