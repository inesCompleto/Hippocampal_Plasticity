...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 26 13:03:56 2021
...
#plt.title('Paired disinhibition and SC \n stimulation from t = 1 min to t = 9 min', fontsize=30, fontweight='bold')
#plt.plot(T_min, g, color='#2197d5', linewidth=3.0)
...
#plt.text(5, 1.25, "$Potentiation$", fontsize=20)
#plt.text(30, 1.25, "$Depression$", fontsize=20)
